function[rrr] = affichage_ellipse(C,theta_0,a,b,theta_points_ellipse,motif, num)
...
rrr = plot([xy_points_ellipse(1,:) xy_points_ellipse(1,1)],[xy_points_ellipse(2,:) xy_points_ellipse(2,1)],motif,'LineWidth',num);