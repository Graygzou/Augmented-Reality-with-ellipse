...
dossier_tag = './images_tag'; 		% dossier ou se trouvent les %05d.jpg a augmenter
dossier_images = './images_flamme'; 	% idem. Attention : il faut imperativement que les augmentations aient la meme taille
dossier_resultats='resultats_flamme'; % Dossier ou ecrire les images augmentees pour visualisation apres coup
taille_sequence=175; % nombre de frame dans les sequences (doit etre inferieur au min des deux !)

%%% Affichage en cours de calcul
display_ = 1;	% Affichage des etapes intermediaires
